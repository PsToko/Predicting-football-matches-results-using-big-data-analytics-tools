...
class ModelManager:
    def __init__(self):
        ...
        self.feature_names = [
            ...
            "home_win_rate", "away_win_rate", "draw_rate", "net_attack", "net_defense",
            "power_diff", "xg_momentum", "win_draw_ratio"
        ]

    def background_train(self):
        try:
            print("Starting training with LightGBM...")
            ...
            lgb.plot_importance(self.model, importance_type='gain', max_num_features=20)
...
class FootballPredictorApp:
    ...
    def setup_ui(self):
        self.root.title("Football Match Predictor (LightGBM)")
    ...
    def setup_test_frame(self):
        test_frame = ttk.LabelFrame(self.root, text="Model Testing", padding=10)
        test_frame.grid(row=5, column=0, columnspan=2, pady=10, padx=5, sticky="ew")
